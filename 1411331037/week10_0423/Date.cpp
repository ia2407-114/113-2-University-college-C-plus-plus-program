...
Date::Date(int year, int month, int day)
{
    ...
    cout << "西元日期:" << setfill('0') << setw(4) << getYear() << "/" << setw(2) << getMonth() << "/" << setw(2) << getDay() << endl;
    // print Time in standard-time format (HH:MM:SS AM or PM)
    int rocYear = getYear() - 1911;
    cout << "民國日期:" << setw(3) << setfill('0') << rocYear << "/" << setw(2) << setfill('0') << getMonth() << "/" << setw(2) << setfill('0') << getDay() << endl;
