...
void FlightObject::display() const {
...
// Constructor for Cargo class to set up cargo plane data
Cargo::Cargo() {
    cout << "\nExecuting the constructor of the subclass Cargo\n";
    cout << "Lessee: ";
    cin >> lessee;
    cout << "Maximum load capacity (kg): ";
    cin >> max_load; // Input the maximum load capacity
}

// Destructor for Cargo class
Cargo::~Cargo() {
    cout << "Executing the destructor of the subclass Cargo.\n";
}

// Display the cargo plane's data
void Cargo::display_cargo() const {
    cout << "Lessee: " << lessee << endl;
    cout << "Maximum load capacity (kg): " << max_load << endl; // Display the max load
}
